...
import * as userInputDatabase from "../firebase.js";
...
function addEmptyRow() {
    ...
    push(userInputDatabase.qualRow, newRow);
}
...
function reset() {
    remove(userInputDatabase.qualTable);
}